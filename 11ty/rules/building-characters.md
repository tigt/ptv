...
Create 2 **Talents**. Talents can be anything unrelated to combat that your character is particularly good at. You get [Advantage](#advantage-and-disadvantage) on Skill Checks related to a Talent. (If you think a Talent may be too broad, ask your GM.) [TODO]  
*Examples:* Swimming, Flexing, Threatening, Baking

Create 2 **Flaws**. Flaws are any activity or trait your character struggles with. You get [Disadvantage](#advantage-and-disadvantage) on Skill Checks related to a Flaw. [TODO]  
...
<table>
<thead>
<tr><th>Battle Stat    <th>Physical Skill<th>Social Skill
</thead>
<tr><th>Attack         <td>Athletics     <td>Intensity
<tr><th>Defense        <td>Endurance     <td>Bluster
<tr><th>Special Attack <td>Focus         <td>Composure
<tr><th>Special Defense<td>Stealth       <td>Insight
<tr><th>Speed          <td>Acrobatics    <td>Deception
</table>
...
Characters also have **Accuracy Rate**, **Evasion**, **Save Bonus**, **Critical Rate**, and **Effect Rate**, which are normally 0, but can change during battle. They’re explained in the [Combat & Danger rules](./combat+danger.md).
...
## Pokémon Teams & Parties

- Trainers can have up to 6 Pokémon with them, called their **Team**.
- Characters allied with the Trainer, both human and Pokémon, are called a **Party**.
- Other Pokémon that belong to that Trainer must stay somewhere else; usually a digital Pokémon Storage System, or a dedicated pasture area, etc.
...
Here’s how you figure out a Pokémon’s Stats at level 1:
...
Pokémon have mysterious powers that humans are always discovering. Pokémon are considered Talented at anything their species is known for doing: Pikachu is talented at Pikachuing, and Machamp is talented at Machamping.

## Types

All Pokémon have one or two **Types** that reflect its elemental affinities. Each Type is weak to certain Types and strong against others, which is called “Type Effectiveness” — often described as “Super Effective” when incoming damage is of a Type the target is weak to, and “Not Very Effective” when the target resists the Type of incoming damage.

Most damage a Pokémon receives is modified by Type effectiveness, and some Types also have special traits:
...
If a Pokémon is **Immune** to a Type, they take no damage from Moves of that Type and ignore its additional effects. (Most Status Moves ignore Immunity; Thunder Wave is a notable exception.)
...
- Check its new stage’s Pokédex entry to see what Move(s) it learned by evolving.
- You may redistribute its Level-up points.
- Change its Abilities to match the same position in their new form’s Ability List.

The Pokémon or its owner can choose not to Evolve. This does not prevent that Pokémon from evolving in the future, such as the next time it Levels Up or otherwise meets the evolution criteria.

### Underdog Pokémon

When a Pokémon is about to evolve, you may choose to cancel the evolution instead to turn it into an **Underdog** Pokémon:
