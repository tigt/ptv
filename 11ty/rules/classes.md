...
| ***Teamwork Orders*** | 1 PP. If your Pokémon uses the same Move as an ally this round, they both gain Advantage on the attack roll. |  |  |
...
|  | *Hiker* |  |  |
| ***Fleet Feet Orders*** | 5 PP. Your Pokémon’s Bonus Move gains Priority this round. Your Pokémon can travel 2 Zones for free before their turn if they use a Bonus Move. |  |  |
...
Type Experts specialize to totally master a specific style. They embody their types in philosophy and combat. Each Type’s Expert has different enough features to be an entirely new class, so [check the list of Type Experts here.](https://docs.google.com/document/d/1cqzC523SNyDm7WFiXmOO8uUP13GLXR7hLhLVEBkbxXY/edit)
