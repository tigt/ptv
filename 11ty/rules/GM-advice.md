...
TODO: [docs.google.com/document/d/1KHjBwldxyMlyvWVJvMsy-0yU7XPH1XG6NNgFR7frBK0/edit](https://docs.google.com/document/d/1KHjBwldxyMlyvWVJvMsy-0yU7XPH1XG6NNgFR7frBK0/edit#heading=h.ihmxtw1a1scz)
also the Legendary Features/Items: [docs.google.com/spreadsheets/d/15yDcu7dXG7PpHniF_V3GR8FGSx6TOxS2CoIdNAg2NYk/edit](https://docs.google.com/spreadsheets/d/15yDcu7dXG7PpHniF_V3GR8FGSx6TOxS2CoIdNAg2NYk/edit?gid=0#gid=0)
...
Tigt — 4:29 PM
notably the D&D rules have never even said that
it's just a persistent houserule
might be worth a callout in our rules about "don't do this"
a 5% chance to autosucceed by divine happenstance is usually an important safety valve though
iirc D&D only has automisses or crits in battle is because the whole point of combat is that even on the top of your game
tiny problems or stalls or lapses in judgment actually do matter, because there's both time and danger pressure
and I'm not even sure D&D officially has automisses

matt "matt palladium" palladium — 4:46 PM
I think it does, but not "fumbles"

The Lady Whiskers — 4:47 PM
It does, And yes, only in combat

matt "matt palladium" palladium — 4:47 PM
you miss but you don't somehow break your sword

The Lady Whiskers — 4:47 PM
Yeah Critical Fails are a house rule

matt "matt palladium" palladium — 4:48 PM
Pathfinder 2e has what it calls crit success/failure for skills, saves, etc. but that's not a nat 20/1, that's "success/failure by A Lot"
I don't remember the threshold but

### Differences from the video games

While PTV strives for game accuracy, _Pokémon_ is based on a video game with complex code behind its battle systems. If you find our system contradicts the official games’ behavior, feel free to correct our rulings for your table’s needs.

For example, we couldn’t figure out how to succinctly word Huge Power and Pure Power to convey that they increase the damage of Body Press and Foul Play in the original games. We opted not to mention it because the fact that _does_ work is already surprising, unintuitive, and not exactly a strategy you’d build around.
...
- **Diamond Dust:** Snow + Hail + Fire/Water Pledge Rainbow
...
Zone Actions need **A.)** an effect (such as damage, a Status, forced travel, etc.) and **B.)** a trigger (a strong wind, entering a Zone with a hidden tile, a Foes in Zone move, end of the round, etc.)
...
- For each turn the Boss has, it gains a Health Bar equal to its Max HP.
  + Instant KO effects (like Horn Drill or Destiny Bond) remove 2 Health Bars, instead of the Boss immediately fainting. (The Boss will still faint if it only had 1 or 2 Health Bars remaining, of course.)
  + When a Health Bar is depleted, any effects that trigger off the Boss fainting happen (like Moxie or Fell Stinger) and a special effect of your choice happens:
    1. Cure the Boss of a Status Problem.
    2. Restore the Boss’s AP by the usual amount they’d start with at their Level.
    3. The Boss restores any Dropped Stats.
    4. The Boss changes its Abilities. If a new Ability triggers on entering battle, trigger it now.
    5. The Boss creates weather or terrain for 5 rounds.
    6. The Boss unleashes an effect of your own creation, like an unlocked Move or new tactic. (Recommended for the penultimate Health Bar.)

#### Boss fight balancing & brainstorming

> While GMs cannot devote as much thought to each players’ possible builds and strategies as the players themselves can (they get to iterate and polish their rotating stable, but GMs have to come up with new guys all the time), GMs can counter that with how much control and planning they can devote to teamwork within their encounters, which then incentivizes players to do the same to overcome it.
> which I think is ideal: incentivizing players to do certain things to win is basically Game Design, especially if those things are fun; and I believe talking to other players and brainstorming how to work together is fun.

>     You're kind of addressing the fundamental struggle of DMing regardless of system
    And so I caution advising around it if we don't specifically build around it.
    In my humble but personal experience, the most honest mistake I've made as a GM of any system is trusting that my players (4 people) can coordinate as well as a team of Just Me can
    Tigt
     — 
    3:39 PM
    yeah I'm not saying "you must do this"
    it'd be more like "if your bosses keep getting steamrolled, here's the lever you can pull"
    The Lady Whiskers
     — 
    3:39 PM
    I think it's maybe an advisable point but that we really need to stress that yeah, pull it as a reaction lever not as a precondition
    Tigt
 — 
3:50 PM
in particular it also works as reverse advice, where by identifying this as probably the most impactful lever of boss power
so if your players struggle against your bosses
break up the synergy first

##### Boss fights with spread moves used by underlings to benefit a leader
- Own Tempo boss with Swaggering/Flattering teammates, Neutralizing Gas + drawback Abilities
- Some unintimidating “boss” that’s hyped up by 6 Intimidate Scraggy, each with Coaching (and maybe even Fake Out)
- Plus/Minus, Gear Up/Magnetic Flux
- Rototiller/Flower Shield
- Coaching/Dragon Cheer, Howl, Jungle Healing/Life Dew/Lunar Blessing
- Friend Guard (which apparently stacks???)
- Aromatic Mist, Decorate, Helping Hand, Copycat
- Bestow in a circumstance where the held item(s) are immediately used up somehow
- Instruct
- Mud Sport and Water Sport was pretty blah in the games, but you’d be surprised how much work they do in PTV

##### Spread damaging Moves that don’t target/affect allies
- Round is pretty strong when everything on one side knows it
- Flash Fire/Well-Baked Body, Lava Plume/Searing Shot
- Dry Skin/Water Absorb/Storm Drain, Surf/Sparkling Aria
- Sap Sipper + Petal Blizzard
- Levitate/Flying-Type/Earth Eater + Magnitude/Bulldoze/Earthquake
- the Telepathy Ability also works for many of these
- Defiant/Competitive/Impulsive, Bulldoze
- Hate Eater/Justified + Brutal Swing
- Wind Rider, Petal Blizzard, alternating Sandstorm with another Weather, Tailwind
- Magnet Rise central Electric-Type boss with Volt Absorb/Lightning Rod/Motor Drive and a bunch of underlings with Parabolic Charge/Discharge
- Soundproof/Ghost-Type, Boomburst/Explosion
- Own Tempo/Tangled Feet, Teeter Dance/Swagger/Flatter
- Spikes/Toxic Spikes, to get the max effect instantly
- Competitive/Defiant/Impulsive + Play Nice/Baby-Doll Eyes/Confide/Defog/Strength Sap(!)
- Skill Swap/Entrainment with Intimidate/Unintimidate/Startle/Enthrall/Chill/"Entry:"/Download/Hospitality/Intrepid Sword/Dauntless Shield/Supersweet Syrup
- Some spread moves that work great for a bunch of underlings spamming them
  - 0 AP: Acid, Bubble, Glaciate, Razor Wind, Shadow Down, Shadow Panic, Shadow Rave, Shadow Storm, Shadow Wave, Sweet Scent, Swift
  - 1 AP: Dark Void, Twister, Venom Drench (if combo'd with Poison Gas)
  - 2 AP: Clanging Scales, Disarming Voice, Growl, Leer, Mortal Spin, Poison Gas, Powder Snow, Tail Whip
  - 3 AP: Air Cutter, Springtide/Sandsear/Wildbolt/Bleakwind Storm, Breaking Swipe, Burning Jealousy, Captivate, Dazzling Gleam, Electroweb, Hyper Voice, Icy Wind, Incinerate, Land's Wrath, Muddy Water, Overdrive, Razor Leaf, Relic Song, Snarl, String Shot, Struggle Bug
  - 4 AP: Core Enforcer, Cotton Spore, Expanding Force (in Psychic Terrain), Fiery Wrath, Heat Wave, Matcha Gotcha, Ominous Wind, Origin Pulse, Precipice Blades, Rock Slide, Thousand Arrows/Waves
  - 5 AP: Blizzard, Diamond Storm, Dragon Energy, Eruption, Water Spout
  - 6 AP: Make It Rain, Tera Starstorm
  - 7 AP: Astral Barrage, Glacial Lance

##### “Magical Christmasland” combos

“Magical Christmasland” describes game combos that normally would have a very low chance to pull off as players, but you _can_ pull off as the GM. Some examples:

- Psych Up to reverse the flow of power _from_ the boss _to_ the underlings (like, say, No Retreat?)
- Big group that all know Roar/Whirlwind/Circle Throw/etc. and hazards
- Dancer for a bunch of foes is a hell of a boss battle
- Harsh Sunlight + Harvest + Teatime + whatever Berries you want
- A bunch of Instruct users + something that knows Gigaton Hammer

##### Fights built around field effects, whether custom, Weather, Terrains, Hazards, or any combination thereof
- Up to you if players can override those effects; counterplay is desirable, but putting up a limp fight because one player remembered to bring Rapid Spin is no fun for everyone else. Include ways to reset your effects, or have overrides only work for a few turns, etc.

##### Fights where the odds are stacked against the players for good reason

Heck, you even have access to rules that players don’t…
...
#### Boss Variant: Horde Pokemon

Sometimes Pokemon attack in hordes, like a swarm of Zubat, a school of Magikarp, or a room of Joltik. Horde variants pretend to be an uncountable number of Pokemon:
...
- To convert Moves to PTV:
  1. Subtract 30 from the Base Power, divide by 5, then round to a whole number. Minimum of 1 for Moves that end up with 0 or less.
     * If you prefer an equation: <math>max(1, Power &minus; 305)</math>
     * If you prefer spreadsheet code: `=MAX(1, ($gamePower - 30)/5)`
  2. The Power of generic Type Z-Moves is calculated the same way from the games’ Z-Power, but that doesn’t help for new Status Moves…
  3. TODO: How to get Accuracy from %
  4. TODO: Advice on adapting effects: find an existing similar Move, or…
  5. TODO: Advice on Z-Move Power/effects and MAX Power
